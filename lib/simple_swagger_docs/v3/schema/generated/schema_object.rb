...
require_relative 'json_schema/json_schema_adjusted_by_openapi_property'
  ...
  module V3
    module Schema
      class SchemaObject
        ...
        include JsonSchemaAdjustedByOpenapiProperty
        ...
        def initialize(openapi_data = {})
          ...
          initialize_json_schema_adjusted_by_openapi_property_args(openapi_data)
          ...
          merged_from_json_schema_adjusted_by_openapi_property!(@schema_object)
        end
        ...
        def externalDocs
          if openapi_data_at_schema_object&.fetch(:externalDocs, nil).is_a?(Hash)
            ...
            @schema_object[:externalDocs] = ExternalDocumentObject.new(data)
          else
